package br.com.hellodev.profile.presenter.features.edit_profile.screen
...
import br.com.hellodev.profile.presenter.features.edit_profile.action.EditProfileAction
import br.com.hellodev.profile.presenter.features.edit_profile.state.EditProfileState
...
private fun EditProfileContent(
    ...
    val imagePickerLauncher = rememberLauncherForActivityResult(
        ...
        onResult = { uri ->
            action(EditProfileAction.OnChangeImage(uri ?: Uri.EMPTY))
        }
    )
                ...
                feedback = {
                    state.feedback?.let { feedback ->
                        if (feedback.show) {
                            FeedbackUI(
                                feedback = feedback,
                                onDismiss = { action(EditProfileAction.DismissFeedback) }
                            )
                        }
                    }
                },
                content = {
                    PrimaryButton(
                        ...
                        onClick = {
                            ...
                            action(EditProfileAction.Update)
                        }
                    )
                }
            )
        ...
        content = { paddingValues ->
            Column(
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(EditProfileAction.OnTextFieldChanged(it, FIRST_NAME))
                    }
                )
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(EditProfileAction.OnTextFieldChanged(it, LAST_NAME))
                    }
                )
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(EditProfileAction.OnTextFieldChanged(it, PHONE))
                    }
                )
