...
sealed class BottomAppBarItems<T>(
    ...
    data object Home : BottomAppBarItems<BottomBarRoutes.Home>(
    ...
    data object Saved : BottomAppBarItems<BottomBarRoutes.Saved>(
    ...
    data object Application : BottomAppBarItems<BottomBarRoutes.ApplicationList>(
    ...
    data object Message : BottomAppBarItems<BottomBarRoutes.Message>(
    ...
    data object Profile : BottomAppBarItems<ProfileRoutes.Profile>(
    ...
    companion object {
        val items = listOf(Home, Saved, Application, Message, Profile)
    }
